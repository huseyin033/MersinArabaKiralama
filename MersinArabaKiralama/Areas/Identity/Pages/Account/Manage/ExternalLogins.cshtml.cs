...
namespace MersinArabaKiralama.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                passwordHash = await userPasswordStore.GetPasswordHashAsync(user, HttpContext?.RequestAborted ?? CancellationToken.None) ?? string.Empty;
            }
